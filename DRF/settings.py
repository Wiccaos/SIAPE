...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'SIAPE.context_processors.static_asset_version',
                'SIAPE.context_processors.notificaciones_usuario',
            ],
        },
    },
]
...
STATIC_CACHE_BUST = config('STATIC_CACHE_BUST', default=str(int(time.time())))
